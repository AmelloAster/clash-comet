...
const TEMP_DIR = path.join(cwd, 'node_modules/.comet');
...
function resolveClash() {
	...
	const CLASH_URL_PREFIX = 'https://github.com/Dreamacro/clash/releases/download/premium/';
...
async function resolveSidecar() {
	const sidecarDir = path.join(cwd, 'apps/desktop/src-tauri', 'sidecar');
...
async function resolveWintun() {
	...
	const targetPath = path.join(cwd, 'apps/desktop/src-tauri/resources', 'wintun.dll');
...
async function resolveService() {
	...
	const resDir = path.join(cwd, 'apps/desktop/src-tauri/resources');

	const repo = 'https://github.com/zzzgydi/clash-verge-service/releases/download/latest';
...
async function resolveMmdb() {
	const url = 'https://github.com/Dreamacro/maxmind-geoip/releases/download/20220512/Country.mmdb';
